//     p1_database_display.dart

import 'package:cloud_firestore/cloud_firestore.dart';
import 'package:flutter/material.dart';

class DatabaseDisplay1 extends StatefulWidget {

  const DatabaseDisplay1({Key? key}) : super(key: key);
  @override
  State<DatabaseDisplay1> createState() => DatabaseDisplay1State();
}
class DatabaseDisplay1State extends State<DatabaseDisplay1> {
  @override
  Widget build (BuildContext context) {
    return Scaffold(
       ...
       */
        ...
        builder: _buildBody,
        /*
                 builder   uses the data from a stream to
